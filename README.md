...
4. Create an Object from a Class in Python. 
...
6. Display data or enhanced data from this Python Object on Project Web Page using "getters".
  * Aditi
...
8. Highlight WOW or insight in doing this project.  (ie Mastery Show adding timing to Class to Displaying it on Web)
